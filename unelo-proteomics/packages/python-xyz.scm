...
(define-public python-pymzml
  (package
    ...
    (synopsis "pymzML is an extension to Python that offers:
  ...
  (package
    ...
    (arguments
	 ...
	 (add-after 'unpack 'remove-python2-scripts
	   (lambda _
	     (map delete-file
		  '("msproteomicstoolslib/util/gnuplot.py" "msproteomicstoolslib/util/latex.py"
